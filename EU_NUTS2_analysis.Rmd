...
Ultimately we arrive to a dataset with 265 NUTS2 regions, 7 versions of the explained variables, 17 explanatory variables, and one metadata variable (the regional code.) Below is a map of complete cases:
...
imp <- FeatureImp$new(predictor_var_select,
                      loss = "mae",
                      n.repetitions = 100)
